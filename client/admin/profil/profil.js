angular.module('MyWordPress.admin.profil', ['ui.router', 'ngRoute'])
.config(['$stateProvider',
	function($stateProvider) {
        ...
        .state("editProfil", {
                    ...
                    views : {
                        "content" : {templateUrl: "admin/profil/updateProfil.html"}
                    }
                }
            );
...
.controller("updateUserCtrl", function ($scope, $http, $location, $state, $window, AuthenticationService) {
    $scope.user_data = {};
